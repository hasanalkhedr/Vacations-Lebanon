                    ...
                    <aside class="hidden w-full lg:inline blue-bg" style="margin-top: 1%;" id="aside-default">
                        <ul>
                            @unless(auth()->user()->hasRole('employee'))
                                <li>
                                    <a class="flex items-center px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-300"
                            ...
                            @if(auth()->user()->hasExactRoles('employee') && auth()->user()->is_supervisor == false)
                                <li>
                                    <a href="{{ url(route('leaves.submitted')) }}"
                                       class="flex items-center px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-300">
                                        <span class="mx-2 font-medium">{{__("Leave Requests")}}</span>
                                    </a>
                                </li>
                            @else
                                <li>
                                    <button type="button" class="flex items-center p-2 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-blue-300" aria-controls="dropdown-leaves" data-collapse-toggle="dropdown-leaves">
                                    ...
                                    <ul id="dropdown-leaves" class="hidden py-2 space-y-2">
                                        <li>
                                            <a href="{{ url(route('leaves.index')) }}"
                                               class="flex items-center p-2 pl-8 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-blue-300">
                            ...
                            @else
                                <li>
                                    <button type="button" class="flex items-center p-2 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-blue-300" aria-controls="dropdown-overtimes" data-collapse-toggle="dropdown-overtimes">
