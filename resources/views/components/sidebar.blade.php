...
<body>
    <div>
        ...
        <div class="lg:flex h-full min-h-screen">
            <div class="lg:flex-column lg:w-1/6 border-blue-200 dark:bg-gray-900 blue-bg">
                <div class="flex flex-row items-center place-content-between">
                    <div class="lg:pt-6">
                        <button data-collapse-toggle="aside-default"
                                class="inline-flex items-center mx-2 p-2 text-sm text-white rounded-lg lg:hidden dark:text-gray-400 dark:hover:bg-gray-700"
                    ...
                    <aside class="hidden w-full lg:inline blue-bg" style="margin-top: 1%" id="aside-default">
                        <ul>
                            @unless(auth()->user()->hasRole('employee'))
                                <li>
                                    <a class="flex items-center px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-300 dark:text-white dark:hover:bg-gray-700"
                            ...
                            @if(auth()->user()->hasExactRoles('employee') && auth()->user()->is_supervisor == false)
                                <li>
                                    <a href="{{ url(route('leaves.submitted')) }}"
                                       class="flex items-center px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-300 dark:text-white dark:hover:bg-gray-700">
                                        <span class="mx-2 font-medium">{{__("Leave Requests")}}</span>
                                    </a>
                                </li>
                            @else
                                <li>
                                    <button type="button" class="flex items-center p-2 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-blue-300 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-leaves" data-collapse-toggle="dropdown-leaves">
                                        <span class="flex-1 mx-2 text-left whitespace-nowrap font-medium text-white" sidebar-toggle-item>Leave Requests</span>
                                    ...
                                    <ul id="dropdown-leaves" class="hidden py-2 space-y-2">
                                        <li>
                                            <a href="{{ url(route('leaves.index')) }}"
                                               class="flex items-center p-2 pl-8 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-blue-300 dark:text-white dark:hover:bg-gray-700">
                            ...
                            @else
                                <li>
                                    <button type="button" class="flex items-center p-2 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-blue-300 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-overtimes" data-collapse-toggle="dropdown-overtimes">
                                        <span class="flex-1 mx-2 text-left whitespace-nowrap font-medium text-white" sidebar-toggle-item>Overtime Requests</span>
                                        <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                    </button>
