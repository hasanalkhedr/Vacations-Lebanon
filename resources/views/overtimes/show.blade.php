<x-sidebar>
    ...
    <div class="m-4">
        ...
        @endif
        <div class="relative z-0 mb-6 w-full group">
            <input type="text" name="date_of_submission" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" disabled value="{{ $overtime->date_of_submission }}" />
