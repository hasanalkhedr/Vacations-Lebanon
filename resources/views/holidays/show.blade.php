            ...
            <form method="POST"
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full group flex flex-col">
                        ...
                        <input type="text" name="from" id="fromDate" placeholder="Please select Date Range" data-input value="{{ $holiday->from }}">
                        @error('from')
                    ...
                    <div class="relative z-0 mb-6 w-full group flex flex-col">
                        ...
                        <input type="text" name="to" id="toDate" placeholder="Please select Date Range" data-input value="{{ $holiday->to }}">
                        @error('to')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
